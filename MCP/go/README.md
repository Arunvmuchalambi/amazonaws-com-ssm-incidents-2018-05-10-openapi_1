...
This MCP (Model Content Protocol) server provides access to AWS Systems Manager Incident Manager API functionality through HTTP, HTTPS, and STDIO transport modes.
