...
func ListincidentrecordsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/listIncidentRecords%s", cfg.BaseURL, queryString)
		...
		var result models.ListIncidentRecordsOutput
...
func CreateListincidentrecordsTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListincidentrecordsHandler(cfg),
	}
}
