...
func PutresourcepolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.PutResourcePolicyOutput
...
func CreatePutresourcepolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_putResourcePolicy",
		mcp.WithDescription("Adds a resource policy to the specified response plan. The resource policy is used to share the response plan using Resource Access Manager (RAM). For more information about cross-account sharing, see <a href="https://docs.aws.amazon.com/incident-manager/latest/userguide/incident-manager-cross-account-cross-region.html">Cross-Region and cross-account incident management</a>."),
		mcp.WithString("policy", mcp.Required(), mcp.Description("Input parameter: Details of the resource policy.")),
		mcp.WithString("resourceArn", mcp.Required(), mcp.Description("Input parameter: The Amazon Resource Name (ARN) of the response plan to add the resource policy to.")),
	)
